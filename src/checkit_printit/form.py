...
#: Written into the pushed script rather than set as a Script Property,
#: because clasp cannot set properties and the point of this path is that
#: nothing is done by hand. The file lives in the instructor's own Apps Script
#: project, which only they can read, and is never committed here.
SECRET_SOURCE = """/**
 * Generated by checkit-printit. Do not commit or share.
 *
 * The web app is reachable without a Google sign-in, because a command line
 * cannot complete one. This is what actually guards it.
 */
var PRINTIT_SECRET_VALUE = %s;
"""


def secret_source(secret):
